# Generated by Django 2.2.10 on 2020-06-07 15:49
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('home', '0010_remove_equipeb_equipe'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_add', models.DateTimeField(auto_now_add=True)),
                ('date_upd', models.DateTimeField(auto_now=True)),
                ('Joueur', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='foot', to='home.Joueur')),
            ],
            options={
